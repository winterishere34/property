  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">住户修改</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal">
		  <div class="form-group">
		    <label class="col-sm-2 control-label">住户名</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="room" class="form-control" id="room_update_input" placeholder="房间号">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal">
		  <div class="form-group">
		    <label class="col-sm-2 control-label">住户姓名</label>
		    <div class="col-sm-10">
		      <input type="text" name="userName" class="form-control" id="userName_add_input" placeholder="请输入姓名">
		      <span class="help-block"></span>
		    </div>
		  </div>
		   <div class="form-group">
	...
	<script type="text/javascript">
		...
		$(document).on("click",".edit_btn",function(){
			...
			//1、查出部门信息，并显示部门列表
			getBuilds("#userUpdateModal select");
			//2、查出员工信息，显示员工信息
		...
		function getUser(id){
			$.ajax({
				...
				success:function(result){
					...
					$("#phone_update_input").val(userData.phone);
					$("#email_update_input").val(userData.email);
					$("#room_update_input").val(userData.room);
					$("#userUpdateModal input[name=gender]").val([userData.gender]);
					$("#userUpdateModal select").val([userData.dId]);
				}
			});
		}
