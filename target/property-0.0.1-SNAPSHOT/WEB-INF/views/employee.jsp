  ...
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript">
		...
		$("#emp_add_modal_btn").click(function(){
			...
			getBuilds("#empAddModal #select_building");
			
			getDepts("#empAddModal #select_department");
			//弹出模态框
			$("#empAddModal").modal({
				backdrop:"static"
			});
		...
		$(document).on("click",".edit_btn",function(){
			...
			//1、查出部门信息，并显示部门列表
			getBuilds("#empUpdateModal #select_building");
			
			getDepts("#empUpdateModal #select_department");
			//2、查出员工信息，显示员工信息
		...
		function getEmp(id){
			$.ajax({
				...
				success:function(result){
					...
					$("#empUpdateModal #select_building").val([empData.bId]);
					$("#empUpdateModal #select_department").val([empData.dId]);
				}
			});
		}
